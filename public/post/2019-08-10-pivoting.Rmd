...
Lets try them out to make the loco_long data wide. For `pivot_wider()`, we need to know the df that we want to make wide, names_from = the column that contains the names to spread, values_from = the dv that you want to spread across columns. 
