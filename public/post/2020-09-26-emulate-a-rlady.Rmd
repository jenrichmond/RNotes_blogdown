...
author: ''
image: "img/portfolio/lubridate_ymd.png"
date: '2020-09-26'
...
Looks like testing rates decline across the working week, and are definitely much lower in the weekend. Interesting that the default start of the week is Sunday. I wonder whether that pattern has changed across the pandemic. 
...
Oh!!! the data I downloaded 28-9-2020 is incomplete. Even though the website says this data is updated every day, the total tests for Sept are bad because we only have data up until 11-9-2020. 
...
- sometimes R automatically recognises your date variables as dates, but I'm not sure why this happens really infrequently with my real world data, probably related to d-m-y format not being the R default
  ...
  + how to convert dates that R things are characters into date format
