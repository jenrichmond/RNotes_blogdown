...
> NOTE: here I am talking about blogging etc, not about xarigan slides (which is definitely on my 2019 to learn list)
...
By having `xarigan::inf_mr()` running in the console, you can have the same functionality of `blogdown::serve_site()` on all markdown documents. And you can use it in blogdown too, so you don't need different knitting tricks for different situations. 
