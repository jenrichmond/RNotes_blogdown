...
image: "img/portfolio/cropped.png"
categories: []
tags: []
output: 
  html_document: 
    includes:
      in_header: customise_card.html
---

```{r include=FALSE}
library(headR)
add_twitter_card(card_type = c("summary"), "customise your R experience",
  description = NULL, user = NULL, image = "http://jenrichmond.rbind.io/post/customise-your-r-experience/", image_alt = NULL,
  file = "customise_card.html")
```
...
![](/post/2019-08-11-customise-your-experience_files/message.png)

Thanks to [Dani Navarro](@djnavarro) and [Charles Grey](@cantabile) for the inspiration!
...
![](/post/2019-08-11-customise-your-experience_files/colbalt.png)

But iCobalt t not the cutest option! There was twitter frenzy last weekend about cuteness in #rstats coding ...
...
![](/post/2019-08-11-customise-your-experience_files/fairy.png)
